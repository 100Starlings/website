    ...
    <section id="testimonials" className="card max-w-7xl p-8">    
      <div className="flex flex-row items-center flex-wrap sm:flex-nowrap sm:gap-x-28">
        <div id="title-section" className="sm:basis-1/3 sm:py-8 sm:pl-8">
          <div className="my-4 w-6 h-6 flex items-center justify-center rounded-full border" style={{border: "1.4px solid #03A79D"}}>
        ...
        <div id="testimonial-section" className="flex items-center sm:basis-2/3 py-4 sm:p-8 min-h-80 mb-4 sm:mb-0 min-h-[25rem]">
         <div className={`testimonial ${isVisible ? 'visible' : ''}`}>
            <p className="mb-[1rem] text-xl dark:text-white text-slate-600 font-extralight leading-relaxed">"{testimonials[current].quote}"</p>
