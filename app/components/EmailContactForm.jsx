					...
					<div>
						...
						<div className="mt-1 xl:mt-2.5">
							<input
								...
								className="block w-full rounded-md border-[1.5px] border-[var(--card-bg)] px-3.5 py-2 shadow-sm ring-0 bg-white/30 focus:outline-transparent text-white backdrop-blur-lg ring-green placeholder focus:ring-0 sm:text-sm sm:leading-6"
							/>
						</div>
					</div>
					<div>
						...
						<div className="mt-1 xl:mt-2.5">
							<input
								...
								className="block w-full rounded-md border-[1.5px] border-[var(--card-bg)] px-3.5 py-2 shadow-sm ring-0 ring-inset bg-white/30 focus:outline-transparent text-white backdrop-blur-lg ring-green placeholder focus-visible:ring-green sm:text-sm sm:leading-6"
							/>
						</div>
					</div>
