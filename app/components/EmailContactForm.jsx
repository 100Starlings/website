		...
		<div className="p-[1rem] lg:p-[2rem] rounded-md w-full z-10">
			<form ref={form} onSubmit={sendEmail} className="mx-auto w-full max-w-screen xl:max-w-lg z-10">
					...
					<div>
						...
						<div className="mt-1 xl:mt-2.5">
							<input
								...
								className="block w-full rounded-md border-[1.5px] border-black/0 px-3.5 py-2 shadow-sm ring-0 ring-inset bg-white/30 focus:outline-transparent text-white backdrop-blur-lg ring-green placeholder focus-visible:ring-green sm:text-sm sm:leading-6"
							/>
						</div>
					</div>
					<div>
				...
				<div className="mt-4 xl:mt-10 flex">
					<button type="submit" value="Send" className="button text-sm">
						Send message
					</button>
				</div>
			</form>
